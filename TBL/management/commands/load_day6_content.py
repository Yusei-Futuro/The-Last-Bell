...
class Command(BaseCommand):
    ...
    def create_situation(self):
        ...
        situation = Situations.objects.create(
            ...
            locations=gimnasio,
            character=kove,
            contexto_situation="En la clase de educación física el profesor les asigna dos opciones: armar acrosport o una clase de algún deporte. Kove conocerá a una persona."
        )
        ...
        line2 = Dialogue.objects.create(situation=situation, line_type='came_thought', text="No estoy seguro qué opción elegir, mejor escuchar primero a los demás.", order=2, decision_point=False)
        line3 = Dialogue.objects.create(situation=situation, line_type='narration', text="Luego de un momento, un compañero se acerca a Kove para presentarse.", order=3, decision_point=False)
        line4 = Dialogue.objects.create(situation=situation, line_type='npc_speech', text="Hola, me presento, mi nombre es Aldo... ¿Y tú? ¿Cómo te llamas?", order=4, decision_point=False)
        line5 = Dialogue.objects.create(situation=situation, line_type='came_speech', text="Mucho gusto, me llamo Kove.", order=5, decision_point=False)
        line6 = Dialogue.objects.create(situation=situation, line_type='npc_speech', text="Igualmente. ¿Has pensado en alguna opción que te guste?", order=6, decision_point=False)
